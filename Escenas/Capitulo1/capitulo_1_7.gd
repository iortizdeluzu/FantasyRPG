...
@onready var message_label = $"ScrollContainer/VBoxContainer/Capitulo17"


# Capítulo actual de la escena (puedes cambiarlo en cada escena)
var capitulo_actual = "1.7"  # Esto lo ajustas en cada escena diferente
...
Goran ruge como un oso herido, su hacha girando sobre su cabeza antes de estrellarse contra el pecho del primer soldado que emerge de las sombras. Las costillas crujen como ramas secas.
